<template>
    ...
    <div class="button-boxes">
      ...
      <button class="button-1">
        <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor" class="bi bi-cloud-plus" viewBox="0 0 16 16">
...
.button-boxes {
  display: flex;
  gap: 20px; /* Space between button boxes */
...
.button-boxes button:hover {
  background-color: #e0e0e0; /* Darken button background on hover */
}
</style>